...
const DataProvider = (({children}) => {
    const [question, setQuestion] = useState([
        {
            questionId: 1,
            title: `당신은 반려동물을 키우게 됐습니다.\n가장 먼저 하고 싶은 일은 ?`,
            answerA: `남는건 사진뿐이야!\n사진찍어서 인스타에 올려야지`,
            answerB: '집에 처음왔는데 적응할시간은 줘야지.\n 그냥 눈으로 보고 있는다',
            type: 'EI'
        },
        {
            questionId: 2,
        ...
        {
            questionId: 3,
            title: '주인과 상책중인 엉덩이가 빵실한 웰시코기와 눈이 마주쳤습니다.\n당신의 행동은 ?',
        ...
        {
            questionId: 4,
            title: '반려동물의 이름을 지어줘야할 때 어떤 이름을 지어주나요 ?',
            answerA: '비슷한 이름이 괜히 있는게 아니다\n"보리,아리,두부"같이 찰떡같은 이름을 지어준다',
            answerB: '내 이름도 흔한이름인데 반려동물마저 흔할수는 없다.\n창의적인 이름을 지어준다',
            type: 'SN'
        },
        {
            questionId: 5,
            title: '반려동물의 건강을 생각하게 됐을 때 어떻게 준비할까요 ?',
            answerA: '반려동물이 언제 아플지는 아무도 모르니\n 아플때마다 그때그때 검색해본다',
            answerB: '어릴때부터 미리미리 준비하고 공부해서\n 언제 아프더라도 대처할 수 있게한다',
            type: 'SN'
        },
        {
            questionId: 6,
            title: '친구가 동물을 키우고싶어 한다면 당신이 친구에게 해줄 말은 ?',
            answerA: '무엇이든 직접 키우게 되면 현실적으로 어렵다.\n 생명을 책임질 자신이 있으면 키워라',
        ...
        },
        {
            ...
            answerA: '치료해도 다시 길로 돌아오면 같은 상황이 생길것이다.\n 그냥 가던 길을 간다',
            answerB: '길고양이도 생명인데 돈이 문제가 아니다.\n 고양이를 데리고 동물병원으로 간다',
            type: 'TF'
        },
        {
            questionId: 8,
            ...
            answerB: '산책에 계획이 왜 필요하냐!\n 그냥 내 발 , 반려동물이 가고싶어 하는데로 간다 ',
            type: 'JP'
        },
        {
            questionId: 9,
